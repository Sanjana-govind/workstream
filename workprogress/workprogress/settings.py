"""
Django settings for workprogress project.
...
SECRET_KEY = 'django-insecure-clmq6^2j94pu@z!+=@oejel#wzp_gvom8t6etxna^37c&jszbo'
...
ROOT_URLCONF = 'workprogress.urls'
...
WSGI_APPLICATION = 'workprogress.wsgi.application'
